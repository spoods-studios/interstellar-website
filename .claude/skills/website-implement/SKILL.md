...
ensure a sibling `{N}-{NN}-SUMMARY.md` exists (the factory board counts a plan
done only once its committed SUMMARY sibling exists). Write any missing ones,
